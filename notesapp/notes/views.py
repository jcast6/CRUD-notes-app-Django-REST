...
# NoteViewSet class, which inherits from ModelViewSet
class NoteViewSet(ModelViewSet):
    # Set the serializer and renderer classes for this view
    serializer_class = NoteSerializer
    renderer_classes = [TemplateHTMLRenderer]

    # method to get a Note object based on its primary key (id)
    ...
    # method to get the queryset of Note objects to display
    ...
    # method to perform a "soft delete" on a Note object
    def perform_destroy(self, instance):
        # Set the is_active field to False and save the instance
        instance.is_active = False
        instance.save()

    # method to handle the GET and POST requests for the note list page
    ...
    # action method to handle the POST request for updating a Note object
    ...
    # action method to handle the POST request for deleting a Note object
    @action(detail=True, methods=['post'])
    @csrf_exempt
