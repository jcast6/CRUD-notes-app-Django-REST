...
class Note(models.Model):
    ...
    # The last_updated_on field is a DateTimeField that is automatically updated
    # each time a Note object is saved
    ...
    # Define a method to return the title of the Note object as a string
    def __str__(self):
        return self.title
